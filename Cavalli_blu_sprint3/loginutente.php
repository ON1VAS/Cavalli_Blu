...
<!DOCTYPE html> 
<html> 
  <head><title>Login utente</title></head>
    <body class="align"> 
        <div class="grid"> 
			...
			<h1 style="color: var(--baseColor); margin-bottom: 4px;">Analizza</h1> 
                <div class="form__field"> 
                    <label for="email" style="color: var(--iconFill); font-weight: bolder;">Word<span class="hidden">E-mail</span>
                    </label>                     
          ...
          <p class="text--center">Vuoi lasciare una recensione o segnalazione? <a href="review.html">Clicca qui</a> <svg class="icon"> 
                    <use xlink:href="#icon-arrow-right"></use>                     
                </svg></p>
          <p class="text--center">Vuoi cambiare account? <a href="index.html">Logout</a> <svg class="icon"> 
                    <use xlink:href="#icon-arrow-right"></use>                     
                </svg></p>
