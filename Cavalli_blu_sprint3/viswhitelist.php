<html>
 <head><title>Visualizza whitelist</title></head>
  <body>
<?php
session_start();
...
if($result && mysqli_num_rows($result) > 0){
	echo "<h1>Ecco tutti i siti della whitelist: </h1>";
  while($row = mysqli_fetch_assoc($result)){
    ...
    echo "<hr/><p>ID Whitelist: $id</p>";
    echo "<p>Sito: $sito</p>";
  }
    echo '<a href="javascript:history.back()"> <br>Torna indietro</a>';
}
else{
    echo "<hr/><p>Non ci sono ancora siti nella whitelist globale!</p>";
    echo '<a href="javascript:history.back()"> <br>Torna indietro</a>';
}
?> 
</body>
